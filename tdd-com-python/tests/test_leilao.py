...
class TestLeilao(TestCase):
    ...
    #ou quando_adicionados_em_ordem_crescente_deve_retornar_o_maior_e_o_menor_valor_de_um_lance
    ...
    def test_na_deve_permitir_propor_um_lance_em_ordem_decrescente(self):
    ...
    def test_deve_retornar_o_mesmo_valor_para_o_maior_e_meno_lance_quando_o_leilao_tiver_apenas_um_lance(self):
    ...
    def test_deve_permitir_propor_um_lance_caso_o_ultimo_usuário_seja_diferente(self):
        yuri = Usuario('Yuri', 500.0)
